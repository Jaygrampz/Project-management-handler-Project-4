...
<<<<<<< HEAD
					pendingToWrite.add(stringFormatter(projectName, projectNumber, buildingType, physicalAddressOfProject, erfNumberForProject,
...
<<<<<<< HEAD
				Date deadlines = null;
				dateComparison(fileProjects, overdueChoice, dateFromProject, currentDate);
=======
...
>>>>>>> projectEditorExp
				...
				try {
					...
					} else if (projectModifierChoice == 3) {
